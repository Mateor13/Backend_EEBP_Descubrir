...
const sendMailToProfesor = (userMail, token) => {
    let info = transporter.sendMail({
        ...
        <p>Para confirmar tu cuenta, por favor haz clic en el siguiente enlace:</p><br>
        <p style="text-align: center;">
            <a href="${process.env.URL_BACKEND}confirmar-token/${encodeURIComponent(token)}" style="background-color: #4CAF50; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Verificar cuenta</a>
        </p>
        <br>
        <p>Si no te has registrado en nuestra plataforma, por favor ignora este correo.</p>
        <p>Saludos cordiales,</p>

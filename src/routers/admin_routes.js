...
import { asignarRepresentanteValidator, justificarInasistenciaValidator, registroAdminValidator, registroAsistenciaEstudiantesValidator, registroCursoValidator, registroEstudianteValidator, registroMateriaValidator, registroProfesorValidator, registroRepresentanteValidator, seleccionarAnioLectivoValidator, terminarAnioLectivoValidator } from '../validators/admin_validator.js'
const router = Router()
...
router.patch('/fecha-fin-periodo', verificarAutenticacion, verificarRolAdmin, seleccionarAnioLectivoValidator, registrarFechaFin)
